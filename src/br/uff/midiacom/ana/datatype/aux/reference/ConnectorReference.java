...
public class ConnectorReference<T extends NCLCausalConnectorPrototype,
    ...
    public ConnectorReference(T target, NCLElementAttributes targetAtt) throws XMLException {
        super(target, targetAtt);
    }


    public ConnectorReference(I alias, T target, NCLElementAttributes targetAtt) throws XMLException {
