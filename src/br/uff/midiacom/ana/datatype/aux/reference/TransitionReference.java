...
public class TransitionReference<T extends NCLTransitionPrototype,
    ...
    public TransitionReference(T target, NCLElementAttributes targetAtt) throws XMLException {
        super(target, targetAtt);
    }


    public TransitionReference(I alias, T target, NCLElementAttributes targetAtt) throws XMLException {
